...
BENCH_FILE=/work/vllm-benchmark/studies/7-tensor-parallelism/k8s/05-job.yaml
...
#
# --timeout=5700s (95m), same as 2-larger-model-g7e (same 12-level, 300s/level ramp):
# up to 900s (15min) one-time dataset-prep on a cold cache + 12 x 300s levels (60min)
